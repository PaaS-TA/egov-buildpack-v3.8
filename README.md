...
#### 2. Manifest 수정
PaaS-TA 전자정부 빌드팩은 두 가지 WAS(Tomcat/Jboss)중 한 가지 WAS를 선택하여 애플리케이션을 구동 시킬수 있도록 구성되어 있다. 어떤 WAS를 선택할지, manifest 파일에 명시한다.  
